...
export default async function (ctx) {
  ...
  const C = {
    bg: [{ light: '#1C1C1E', dark: '#1C1C1E' }, { light: '#0C0C0E', dark: '#0C0C0E' }],
    block: { light: '#2C2C2E', dark: '#2C2C2E' }, 
    main: { light: '#FFFFFF', dark: '#FFFFFF' },
    sub: { light: '#D1D1D6', dark: '#D1D1D6' },
    muted: { light: '#8E8E93', dark: '#8E8E93' },
    gold: { light: '#D6A53A', dark: '#D6A53A' },     
    red: { light: '#FF453A', dark: '#FF453A' },      
    teal: { light: '#32D74B', dark: '#32D74B' },     
    blue: { light: '#5E8EB8', dark: '#5E8EB8' } 
  };
