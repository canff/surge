...
export default async function(ctx) {
  const C = {
  bg: [{ light: '#78350F', dark: '#1E293B' }, { light: '#33272A', dark: '#33272A' }, { light: '#18122B', dark: '#18122B' }],
  main: { light: '#FFFFFF', dark: '#FFFFFF' },
  sub: { light: '#F3F4F6', dark: '#F3F4F6' },
  muted: { light: '#D1D5DB', dark: '#D1D5DB' },
  divider: { light: '#374555', dark: '#374555' },
  gold: { light: '#D6A53A', dark: '#D6A53A' },
  yi: { light: '#32D74B', dark: '#32D74B' },
  ji: { light: '#FF453A', dark: '#FF453A' },
  term: { light: '#73A491', dark: '#73A491' },
